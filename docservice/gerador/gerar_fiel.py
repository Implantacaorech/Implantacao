# -*- coding: utf-8 -*-
"""Dispatcher da geração fiel de Levantamento/Projeto/Termo (.docx) — adaptação stateless
de webapp/gerar_layout.py:gerar(). A lógica de substituição de placeholders continua
100% em gl_levantamento.py/gl_projeto.py/gl_termo.py/preencher_layout.py, copiados sem
alterar a lógica; só a resolução do arquivo-base muda: aqui ele já chega em bytes (o
NestJS lê do seu próprio store de ModeloDocumento e envia), em vez de buscado por
