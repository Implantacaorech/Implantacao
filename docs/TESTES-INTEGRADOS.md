...
- **Gerado em:** 2026-09-02 · **atualizado em:** 2026-09-03
- **Gerado a partir de:** [`GERARTESTEINTEGRADOPLAYWRIGHT.md`](../GERARTESTEINTEGRADOPLAYWRIGHT.md)
- **Estado de referência:** `193f9c0` (branch `fix/contatos-do-cliente-no-cartao`)
...
| `controle-atividades` | 34 | 10 | parcial | fronteira Rech↔cliente coberta (CT-127..133); checklist, anexos, comentários e Trello — P1 |
...
**Total: 113/306 rotas de API exercitadas** por pelo menos um caso.
...
Os **135 casos** declarados (**142** em execução — dois deles são parametrizados: CT-108 roda
em 3 viewports e CT-109 em 6 logins). Distribuição: **107 P0**, **23 P1**, **5 P2**.
...
| CT-127 | o quadro nasce com as colunas padrão, e o Bastidor Rech fechado ao cliente | P0 | `/api/atividades/cartoes`, `/api/atividades/cartoes/:id`, `/api/atividades/cartoes/:id/mover`, `/home` +13 | [13-controle-atividades.spec.ts:52](../e2e/testes/13-controle-atividades.spec.ts#L52) | ativo |
| CT-128 | um cliente não alcança o quadro do outro | P0 | `/api/atividades/cartoes`, `/api/atividades/cartoes/:id`, `/api/atividades/cartoes/:id/mover`, `/home` +13 | [13-controle-atividades.spec.ts:85](../e2e/testes/13-controle-atividades.spec.ts#L85) | ativo |
| CT-129 | cartão criado pelo interno nasce FECHADO; compartilhar é ato explícito | P0 | `/api/atividades/cartoes`, `/api/atividades/cartoes/:id`, `/api/atividades/cartoes/:id/mover`, `/home` +13 | [13-controle-atividades.spec.ts:130](../e2e/testes/13-controle-atividades.spec.ts#L130) | ativo |
| CT-130 | o cartão aberto pelo CLIENTE nasce compartilhado (é uma solicitação) | P0 | `/api/atividades/cartoes`, `/api/atividades/cartoes/:id`, `/api/atividades/cartoes/:id/mover`, `/home` +13 | [13-controle-atividades.spec.ts:166](../e2e/testes/13-controle-atividades.spec.ts#L166) | ativo |
| CT-131 | o cliente não empurra o próprio cartão para dentro do bastidor da Rech | P0 | `/api/atividades/cartoes`, `/api/atividades/cartoes/:id`, `/api/atividades/cartoes/:id/mover`, `/home` +13 | [13-controle-atividades.spec.ts:194](../e2e/testes/13-controle-atividades.spec.ts#L194) | ativo |
| CT-132 | interno não designado LÊ o quadro e não ESCREVE nele | P0 | `/api/atividades/cartoes`, `/api/atividades/cartoes/:id`, `/api/atividades/cartoes/:id/mover`, `/home` +14 | [13-controle-atividades.spec.ts:247](../e2e/testes/13-controle-atividades.spec.ts#L247) | ativo |
| CT-134 | o cliente edita a solicitação que abriu, e não o cartão da Rech | P0 | `/api/atividades/cartoes`, `/api/atividades/cartoes/:id`, `/api/atividades/cartoes/:id/mover`, `/home` +13 | [13-controle-atividades.spec.ts:275](../e2e/testes/13-controle-atividades.spec.ts#L275) | ativo |
| CT-135 | os consultores oferecidos são só os designados no projeto | P0 | `/api/atividades/cartoes`, `/api/atividades/cartoes/:id`, `/api/atividades/cartoes/:id/mover`, `/home` +13 | [13-controle-atividades.spec.ts:340](../e2e/testes/13-controle-atividades.spec.ts#L340) | ativo |
| CT-133 | sem o menu  | P0 | `/api/atividades/cartoes`, `/api/atividades/cartoes/:id`, `/api/atividades/cartoes/:id/mover`, `/home` +12 | [13-controle-atividades.spec.ts:379](../e2e/testes/13-controle-atividades.spec.ts#L379) | ativo |
...
- **CT-127 — o quadro nasce com as colunas padrão, e o Bastidor Rech fechado ao cliente**  
  ...
  `/api/atividades/cartoes` · `/api/atividades/cartoes/:id` · `/api/atividades/cartoes/:id/mover` · `/api/atividades/cartoes/:id/visibilidade` · `/api/atividades/consultores` · `/api/atividades/quadros` · `/api/atividades/quadros/:id` · `/api/atividades/quadros/:id/listas` · `/api/auth/login` · `/api/permissoes/papel` · `/api/projetos` · `/api/projetos/:id` · `/api/projetos/:id/passos/:id/concluir` · `/api/projetos/:id/passos/:id/conferir` · `/api/projetos/:id/pessoas` · `/api/usuarios` · tela `/home`
...
- **CT-132 — interno não designado LÊ o quadro e não ESCREVE nele**  
  ...
  `/api/atividades/cartoes` · `/api/atividades/cartoes/:id` · `/api/atividades/cartoes/:id/mover` · `/api/atividades/cartoes/:id/visibilidade` · `/api/atividades/consultores` · `/api/atividades/quadros` · `/api/atividades/quadros/3180/listas` · `/api/atividades/quadros/:id` · `/api/atividades/quadros/:id/listas` · `/api/auth/login` · `/api/permissoes/papel` · `/api/projetos` · `/api/projetos/:id` · `/api/projetos/:id/passos/:id/concluir` · `/api/projetos/:id/passos/:id/conferir` · `/api/projetos/:id/pessoas` · `/api/usuarios` · tela `/home`
- **CT-134 — o cliente edita a solicitação que abriu, e não o cartão da Rech**  
  P0 · ativo · [13-controle-atividades.spec.ts:275](../e2e/testes/13-controle-atividades.spec.ts#L275)  
  `/api/atividades/cartoes` · `/api/atividades/cartoes/:id` · `/api/atividades/cartoes/:id/mover` · `/api/atividades/cartoes/:id/visibilidade` · `/api/atividades/consultores` · `/api/atividades/quadros` · `/api/atividades/quadros/:id` · `/api/atividades/quadros/:id/listas` · `/api/auth/login` · `/api/permissoes/papel` · `/api/projetos` · `/api/projetos/:id` · `/api/projetos/:id/passos/:id/concluir` · `/api/projetos/:id/passos/:id/conferir` · `/api/projetos/:id/pessoas` · `/api/usuarios` · tela `/home`
- **CT-135 — os consultores oferecidos são só os designados no projeto**  
  P0 · ativo · [13-controle-atividades.spec.ts:340](../e2e/testes/13-controle-atividades.spec.ts#L340)  
  `/api/atividades/cartoes` · `/api/atividades/cartoes/:id` · `/api/atividades/cartoes/:id/mover` · `/api/atividades/cartoes/:id/visibilidade` · `/api/atividades/consultores` · `/api/atividades/quadros` · `/api/atividades/quadros/:id` · `/api/atividades/quadros/:id/listas` · `/api/auth/login` · `/api/permissoes/papel` · `/api/projetos` · `/api/projetos/:id` · `/api/projetos/:id/passos/:id/concluir` · `/api/projetos/:id/passos/:id/conferir` · `/api/projetos/:id/pessoas` · `/api/usuarios` · tela `/home`
- **CT-133 — sem o menu **  
  P0 · ativo · [13-controle-atividades.spec.ts:379](../e2e/testes/13-controle-atividades.spec.ts#L379)  
  `/api/atividades/cartoes` · `/api/atividades/cartoes/:id` · `/api/atividades/cartoes/:id/mover` · `/api/atividades/cartoes/:id/visibilidade` · `/api/atividades/consultores` · `/api/atividades/quadros` · `/api/atividades/quadros/:id` · `/api/atividades/quadros/:id/listas` · `/api/auth/login` · `/api/permissoes/papel` · `/api/projetos` · `/api/projetos/:id` · `/api/projetos/:id/passos/:id/concluir` · `/api/projetos/:id/passos/:id/conferir` · `/api/projetos/:id/pessoas` · tela `/home`
...
- **`controle-atividades`** (24/34): `GET /atividades/busca`, `DELETE /atividades/cartoes/:id`, `POST /atividades/cartoes/:id/anexos`, `DELETE /atividades/cartoes/:id/anexos/:anexoId`, `GET /atividades/cartoes/:id/anexos/:anexoId`, `POST /atividades/cartoes/:id/anexos/link`, `POST /atividades/cartoes/:id/checklist`, `DELETE /atividades/cartoes/:id/checklist/:itemId`, `PATCH /atividades/cartoes/:id/checklist/:itemId`, `POST /atividades/cartoes/:id/comentarios`, `POST /atividades/cartoes/:id/membros`, `DELETE /atividades/cartoes/:id/membros/:membroId`, `GET /atividades/clientes`, `GET /atividades/contatos/:codigo`, `GET /atividades/etiquetas`, `DELETE /atividades/listas/:id`, `PATCH /atividades/listas/:id`, `POST /atividades/notificacoes/lidas`, `GET /atividades/projetos-disponiveis`, `POST /atividades/quadros/:codigo/importar/trello`, `POST /atividades/quadros/:codigo/importar/trello/previa`, `POST /atividades/quadros/:codigo/responsaveis`, `DELETE /atividades/quadros/:codigo/responsaveis/:usuarioId`, `POST /atividades/quadros/:codigo/responsaveis/sincronizar`
...
| 2026-09-03 | 1.0.1 | **Correção de defeito, sem superfície nova.** `GET /api/atividades/contatos/:codigo` passou a chamar `sicla.contatos.do-cliente` (a AGENDA do cliente) em vez de `sicla.contatos.listar` (AUTORIZAÇÃO, filtrada por `PORTAL_RECH_CLIENTES = 1`) — o seletor "do lado do cliente" do cartão oferecia quase ninguém. Rota e contrato de resposta iguais; a Seção 3 não muda. Coberto por teste unitário: a consulta depende do SICLA, que por decisão não existe na instância isolada. | — |
| 2026-09-03 | 1.1.0 | **Quatro pedidos do usuário sobre o lado CLIENTE.** (1) O cliente passa a EDITAR a solicitação que abriu — antes a descrição nascia somente-leitura e não havia onde dizer do que se tratava; (2) criar um cartão passa a ABRIR o cartão, para existir esse lugar; (3) `GET /api/atividades/consultores` passou a exigir `?codigo=` e devolve só quem é designado no projeto daquele cliente — antes devolvia o cadastro interno inteiro (**mudança de contrato numa rota existente**, sem rota nova); (4) sessão cai após **30 min sem atividade de gente**, nos dois lados. | **CT-134**, **CT-135** |
