    ...
    {"id": "consultor", "nome": "Consultor de Implantação", "icone": "🛠️",
     ...
     "acoes": [
         ...
         {"id": "chkform", "nome": "Check List do Consultor (após o Projeto)", "tipo": "form_modulos", "gera": "checklist",
          "desc": "Depois do Projeto: selecione os módulos FINAIS (com inclusões/retiradas do levantamento) e gere a planilha-guia (Roteiro e Check List) para quem assumirá a implantação."},
