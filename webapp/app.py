...
# Rota /editar/<doc> (edição estruturada): movida para routes_geracao.py.
...
# Rotas /config/imap e /config/gmail: ver routes_config.py.
...
# ---------- F: cronograma e check-list editáveis no painel ----------
# Rotas e helpers movidos para routes_cronograma.py (registrados no fim deste arquivo).
