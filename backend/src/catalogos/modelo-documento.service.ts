...
const CAMPOS_DEFAULT: Record<string, CampoDefault[]> = {
  levantamento: [
    ...
    [
      'Identificação',
      'Responsáveis: <...>',
      'Responsáveis (GCI/Consultor)',
      'projeto.gci + designações',
      false,
      '',
    ],
    [
    ...
    [
      ...
      'manual',
      false,
      'Produto principal do cliente',
    ],
    [
      'Identificação da Empresa',
      'Fornecedor Atual Software:',
      'Software atual',
      'manual',
      false,
      '',
    ...
    [
      'Identificação da Empresa',
      '<Quantidade usuários e identificação:>',
      'Qtd. de usuários',
      'manual',
      false,
      '',
    ...
    [
      'Usuários (tabela)',
      'Nome / E-mail / Atribuições',
      'Usuários-chave',
      'designações / usuarios',
      false,
      '',
    ],
    [
      'Módulos e Adicionais (A)',
      'Previstos antes do Levantamento',
      'Módulos contratados',
      'projeto.modulos',
      true,
      '',
    ...
    [
      ...
      'Quantidade de horas Cobradas',
      'Horas cobradas',
      'projeto.horas_cobradas',
      false,
      '',
    ],
    [
      'Implantação/Treinamento',
      'Quantidade de horas Bonificadas',
      'Horas bonificadas',
      'projeto.horas_bonificadas',
      false,
      '',
    ],
    [
      'Conversões',
      'CONVERSÕES <(xxxx horas)>',
      'Conversões',
      'manual',
      false,
      '',
    ...
    [
      'Mapeamento por área',
      '<Colar aqui o quadro com as perguntas>',
      'Tópicos por módulo',
      'Cadastro: Índice de Tópicos',
      false,
      'Usar o cadastro Índice de Tópicos por módulo',
    ],
  ],
  projeto: [
    [
    ...
    [
      'Conversões (tabela)',
      'Conversão (Sim/Não) / Dados / Obs',
      'Conversões por módulo',
      'manual',
      false,
      '',
    ],
    [
      ...
      '- Módulos Previstos <XX>',
      'Módulos previstos por área',
      'projeto.modulos',
      true,
      '',
    ],
    [
      'Detalhamento das Rotinas',
      'Detalhamento das rotinas <XX>',
      'Rotinas atendidas',
      'Cadastro: Índice de Tópicos / manual',
      false,
      '',
    ],
    [
    ...
    [
      'Tabela de Usuários',
      'Nome / E-mail / Área / Assina Protocolo',
      'Usuários do cliente',
      'designações / usuarios',
      false,
      '',
    ...
    [
      ...
      'Período previsto <XX>',
      'Datas das etapas',
      'cronograma_itens / datas',
      false,
      '',
    ],
    [
      'Tempo Estimado',
      '<XX horas bonificadas>',
      'Horas bonificadas',
      'projeto.horas_bonificadas',
      false,
      '',
  ...
  cronograma: [
    ...
    [
      'Aba: Cronograma de visitas',
      'Data / Local / Turno / Horário / Técnico / Módulo(s) / O que será abordado / Ações',
      'Linhas de visita',
      'cronograma_itens',
      false,
      '',
    ...
    [
      'Aba: Tarefas_usuários',
      'Tipo / Tarefa / Status / Responsável / Datas',
      'Tarefas do usuário',
      'checklist_itens / manual',
      false,
      '',
    ],
    [
      'Aba: Pendências_Consultores',
      'Tipo / Tarefa / Prazo / Status / Dias de atraso',
      'Pendências',
      'manual',
      false,
      '',
  ...
  termo: [
    ...
    [
      'Resumo Geral (tabela)',
      'Módulo / Adicional / Processo / Status de Uso / Obs.',
      'Módulos e status de uso',
      'projeto.modulos / designações',
      false,
      '',
    ],
    [
    ...
    [
      'Pendências',
      '<Pendência 01> / <Técnico responsável> / <Detalhamento>',
      'Pendências sequenciadas',
      'manual',
      false,
      '',
    ],
  ...
  async seedDefaults(baseDir?: string): Promise<number> {
    ...
    for (let i = 0; i < MODELOS_DEFAULT.length; i++) {
      ...
      for (let j = 0; j < campos.length; j++) {
        const [secao, placeholder, rotulo, origem, obrigatorio, observacao] =
          campos[j];
