...
export const PRONTIDAO_ACHADOS: AchadoProntidao[] = [
  ...
  },
  {
    ...
    correcao:
      'limits.fileSize por rota (generoso para vídeo, apertado para anexo).',
    status: 'aberto',
    dono: 'software',
    prazo: '2026-08-26',
  },
  ...
  },
  {
    ...
    correcao:
      'Definir destinatários, logar sempre o motivo de não enviar, heartbeat do digest.',
    status: 'aberto',
    dono: 'usuário + software',
    prazo: '2026-08-19',
  },
  {
    ...
    correcao: 'Contador de 5xx exposto como checagem em /api/saude.',
    status: 'aberto',
    dono: 'software',
    prazo: '2026-09-02',
  },
  ...
  },
  {
    ...
    correcao:
      'connectTimeout/callTimeout no Oracle e o timeoutMs do OpenRouter.',
    status: 'aberto',
    dono: 'software',
    prazo: '2026-08-26',
  },
  ...
  },
  {
    ...
    correcao: 'Redirecionar a saída do docservice para arquivo.',
    status: 'aberto',
    dono: 'software',
    prazo: '2026-08-26',
  },
  ...
  // ---- Médio (seleção) ----
  {
    ...
    correcao: 'Condicionar a não-produção ou por guard.',
    status: 'aberto',
    dono: 'software',
    prazo: '2026-08-26',
  },
  ...
  },
  {
    ...
    correcao: 'Adicionar @Permissao como na rota irmã criar.',
    status: 'aberto',
    dono: 'software',
    prazo: '2026-08-26',
  },
