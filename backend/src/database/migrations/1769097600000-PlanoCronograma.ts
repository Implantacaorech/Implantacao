...
export class PlanoCronograma1769097600000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(`CREATE INDEX "IDX_cronograma_itens_projeto_id" ON "cronograma_itens" ("projeto_id");`);
    ...
    `);
    await queryRunner.query(`CREATE INDEX "IDX_checklist_itens_projeto_id" ON "checklist_itens" ("projeto_id");`);
    ...
    `);
    await queryRunner.query(`CREATE INDEX "IDX_modificacoes_projeto_id" ON "modificacoes" ("projeto_id");`);
  }
